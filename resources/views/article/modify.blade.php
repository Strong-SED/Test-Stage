...
<head>
    ...
    <title>{{ config("app.name").  " | "  . "Modifier"}}</title>
                ...
                class="flex flex-col w-full max-w-4xl mx-auto bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 shadow-lg">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
                        ...
                        <div class="flex flex-col">
                            ...
                            <textarea name="context" id="context" rows="9"
                                placeholder="Ajoutez un contexte ici..."
                                class="w-full outline-none rounded-2xl text-slate-950 px-6 py-4 text-lg border border-gray-300 focus:ring-2 focus:ring-orange-700 resize-none">
                                {{ old('context', $art->context) }}
                            </textarea>
                        </div>
                    </div>
