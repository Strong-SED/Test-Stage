...
<body class="antialiased pt-10 pb-16 bg-slate-950 text-slate-50 ">
    ...
    <div
        ...
        <main
            class=" mt-8 py-5 px-5 rounded-md">
            ...
            <div
                ...
                <article
                    ...
                    class="flex flex-col lg:flex-row pb-8 md:pb-4 border-b border-slate-50      bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-6 shadow-lg lg:hover:translate-x-6 lg:hover:scale-100 transition-all duration-700"
                    x-data="{
                    ...
                    <div class="flex flex-col items-start mt-5 space-y-5 lg:w-7/12 lg:mt-0 lg:ml-12">
                        ...
                        <div
                            ...
                            x-cloak
                            x-transition.duration.800ms
                            class="lg:absolute lg:-bottom-10 lg:-right-56 z-10 lg:bg-slate-300 flex flex-row justify-center w-full lg:flex-col lg:w-52 rounded-md overflow-hidden py-2">
                            <a
                                x-transition.duration.800ms
